...
def translate_cnot(circuit, location):
    ...
    for ct in location:
        ...
        circuit.data.insert(counter,(op,[Qubit(QuantumRegister(circuit.num_qubits, 'q'), qb[0])],[]))
        circuit.data.insert(counter+1,(op,[Qubit(QuantumRegister(circuit.num_qubits, 'q'), qb[1])],[]))
    return circuit
...
def find_cuts(
    ...
    for num_subcircuit in num_subcircuits:
        ...
        if feasible:
            # print(mip_model.cut_edges, mip_model.num_cuts_g, mip_model.num_cuts_w)
