...
from circ_gen.generators import gen_hwea, gen_BV, gen_adder, gen_uccsd
from circ_gen.random_benchmark import RandomCircuit
...
def construct_random(num_qubits, depth):
    random_circuit_obj = RandomCircuit(
        width=num_qubits, depth=depth, connection_degree=0.9, num_hadamards=5, seed=None
    )
